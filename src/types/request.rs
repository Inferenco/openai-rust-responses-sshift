...
impl RequestBuilder {
    /// Creates a new request builder with default values
    pub fn new() -> Self {
        Self {
    ...
    #[must_use]
    pub fn model(&mut self, model: impl Into<crate::types::Model>) -> &mut Self {
    ...
    #[must_use]
    pub fn input_items(&mut self, items: Vec<crate::types::InputItem>) -> &mut Self {
    ...
    #[must_use]
    pub fn tools(&mut self, tools: Vec<crate::types::Tool>) -> &mut Self {
    ...
    #[must_use]
    pub fn tool_choice(&mut self, tool_choice: crate::types::ToolChoice) -> &mut Self {
    ...
    #[must_use]
    pub fn previous_response_id(&mut self, id: impl Into<String>) -> &mut Self {
    ...
    /// Builds the request, consuming the builder
