...
impl VectorStores {
    ...
    pub async fn get(&self, vector_store_id: &str) -> Result<VectorStore> {
        let response = self
            .client
            .get(format!("{}/vector_stores/{}", self.base_url, vector_store_id))
            .send()
            .await
            .map_err(crate::Error::Http)?;
    ...
    ///
    /// Returns an error if the request fails to send or has a non-200 status code.
    pub async fn list(&self, params: Option<PaginationParams>) -> Result<PaginatedList<VectorStore>> {
    ...
    pub async fn delete(&self, vector_store_id: &str) -> Result<()> {
        let response = self
            .client
            .delete(format!("{}/vector_stores/{}", self.base_url, vector_store_id))
            .send()
            .await
            .map_err(crate::Error::Http)?;
    ...
    ///
    /// Returns an error if the request fails to send or has a non-200 status code.
    pub async fn add_files(&self, vector_store_id: &str, request: AddFilesToVectorStoreRequest) -> Result<VectorStore> {
        let response = self
            .client
            .post(format!("{}/vector_stores/{}/files", self.base_url, vector_store_id))
            .json(&request)
            .send()
            .await
            .map_err(crate::Error::Http)?;
    ...
    pub async fn delete_file(&self, vector_store_id: &str, file_id: &str) -> Result<VectorStore> {
        let response = self
            .client
            .delete(format!("{}/vector_stores/{}/files/{}", self.base_url, vector_store_id, file_id))
            .send()
            .await
            .map_err(crate::Error::Http)?;
    ...
    ///
    /// Returns an error if the request fails to send or has a non-200 status code.
    pub async fn search(&self, vector_store_id: &str, request: SearchVectorStoreRequest) -> Result<SearchVectorStoreResponse> {
        let response = self
            .client
            .post(format!("{}/vector_stores/{}/search", self.base_url, vector_store_id))
            .json(&request)
            .send()
            .await
            .map_err(crate::Error::Http)?;
